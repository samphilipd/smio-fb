...
* Update the connection parameters for the database in the `smio-fb.db.core` namespace of your application.
...
Request middleware functions are located under the `smio-fb.middleware` namespace.
